    ...
    <footer className="mt-auto border-t border-zinc-200 bg-zinc-950 text-zinc-300">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid gap-10 md:grid-cols-4">
          <div className="md:col-span-2">
            ...
            <p className="mt-4 max-w-sm text-sm leading-relaxed text-zinc-400">
              SEBI and Companies Act compliant whistleblower system for Indian
              SMBs. Anonymous web + WhatsApp reporting, case management, and a
              tamper-proof audit log — live in 48 hours.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2.5 text-sm text-zinc-400">
              <li>SEBI LODR Reg. 9(6)</li>
              <li>Companies Act §177 (Vigil Mechanism)</li>
              <li>DPDP Act 2023</li>
              <li>POSH Act 2013</li>
            </ul>
          </div>
        ...
        <div className="mt-10 flex flex-col items-start justify-between gap-3 border-t border-zinc-800 pt-6 text-xs text-zinc-500 sm:flex-row sm:items-center">
          <p>© {new Date().getFullYear()} ShieldWhistle. Built for compliant Indian enterprises.</p>
